...
namespace Yafrk\Db\Adapter\Metadata;

use Yafrk\Cache\CachePool;
use Yafrk\Db\Adapter\AdapterInterface;
use Yafrk\Cache\Storage\StorageInterface as CacheStorage;
...
abstract class AbstractMetadata implements MetadataInterface
{
    ...
    public function __construct(AdapterInterface $adapter)
    {
        ...
        try {
            ...
            if ($this->cacher instanceof \Yafrk\Cache\Storage\StorageInterface) {
