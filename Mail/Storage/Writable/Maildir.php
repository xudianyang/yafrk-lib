...
namespace Yafrk\Mail\Storage\Writable;

use Yafrk\Mail\Exception as MailException;
use Yafrk\Mail\Storage;
use Yafrk\Mail\Storage\Exception as StorageException;
use Yafrk\Mail\Storage\Folder;
use Yafrk\Stdlib\ErrorHandler;
