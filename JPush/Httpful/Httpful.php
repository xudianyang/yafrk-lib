...
class Httpful {
     ...
     */
    public static function register($mimeType, \Yafrk\JPush\Httpful\Handlers\MimeHandlerAdapter $handler)
    {
    ...
    public static function get($mimeType = null)
    {
        ...
        if (empty(self::$default)) {
            self::$default = new \Yafrk\JPush\Httpful\Handlers\MimeHandlerAdapter();
        }
